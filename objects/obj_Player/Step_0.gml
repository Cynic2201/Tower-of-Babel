...
/// @DnDVersion : 1
/// @DnDHash : 1C999574
/// @DnDArgument : "code" "$(13_10)y = clamp(y, 95, 670)$(13_10)x = clamp(x, 90, 1290)"
...
if(moving == false)
{
	...
	with(obj_Player) var l3B077EA9_0 = playerDir == 0;
	if(l3B077EA9_0)
	{
	...
	/// @DnDArgument : "var" "playerDir"
	/// @DnDArgument : "value" "1"
	with(obj_Player) var l15E3340F_0 = playerDir == 1;
	if(l15E3340F_0)
	{
		/// @DnDAction : YoYo Games.Instances.Set_Sprite
		/// @DnDVersion : 1
	...
	/// @DnDArgument : "var" "playerDir"
	/// @DnDArgument : "value" "2"
	with(obj_Player) var l1710E3B5_0 = playerDir == 2;
	if(l1710E3B5_0)
	{
		/// @DnDAction : YoYo Games.Instances.Set_Sprite
		/// @DnDVersion : 1
	...
	/// @DnDArgument : "var" "playerDir"
	/// @DnDArgument : "value" "3"
	with(obj_Player) var l3E0CCA19_0 = playerDir == 3;
	if(l3E0CCA19_0)
	{
		/// @DnDAction : YoYo Games.Instances.Set_Sprite
		/// @DnDVersion : 1
...
/// @DnDSaveInfo : "obj" "obj_Shield"
var l062C363F_0 = false;
l062C363F_0 = instance_exists(obj_Shield);
if(l062C363F_0)
{
