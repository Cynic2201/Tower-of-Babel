...
if (l429A2B6A_0)
{
	...
	l420B4033_0 = instance_exists(obj_Player);
	if(l420B4033_0)
	{
		...
		with(obj_Player) var l757F5FCD_0 = playerDir == 0;
		if(l757F5FCD_0)
		{
		...
		/// @DnDArgument : "var" "playerDir"
		/// @DnDArgument : "value" "1"
		with(obj_Player) var l127909AA_0 = playerDir == 1;
		if(l127909AA_0)
		{
			/// @DnDAction : YoYo Games.Movement.Jump_To_Point
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "var" "playerDir"
		/// @DnDArgument : "value" "2"
		with(obj_Player) var l56747280_0 = playerDir == 2;
		if(l56747280_0)
		{
			/// @DnDAction : YoYo Games.Movement.Jump_To_Point
			/// @DnDVersion : 1
		...
		/// @DnDArgument : "var" "playerDir"
		/// @DnDArgument : "value" "3"
		with(obj_Player) var l5107CB8F_0 = playerDir == 3;
		if(l5107CB8F_0)
		{
			/// @DnDAction : YoYo Games.Movement.Jump_To_Point
			/// @DnDVersion : 1
