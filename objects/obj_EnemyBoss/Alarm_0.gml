...
l2909B90F_0 = instance_exists(obj_Player);
if(l2909B90F_0)
{
	...
	if(attack == 2)
	{
		...
		/// @DnDArgument : "objectid" "obj_EnemyBlob"
		/// @DnDSaveInfo : "objectid" "obj_EnemyBlob"
		instance_create_layer(x + 0, y + 0, "Instances", obj_EnemyBlob);
	}
